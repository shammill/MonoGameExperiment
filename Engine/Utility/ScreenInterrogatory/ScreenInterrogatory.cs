...
namespace Engine.Utility.ScreenInterrogatory
{
    public static class ScreenInterrogatory
    {
        ...
        public struct DEVMODE
        {
            ...
            public int dmBitsPerPel; // 1 << vDevMode.dmBitsPerPel
        ...
        public static List<string> DeviceFriendlyNames(this Screen screen)
        {
        ...
        public static string GetCurrentScreenResolution()
        {
            ...
            int numberOfMonitors = GetSystemMetrics(0x80);
        ...
        public static List<Size> GetDisplayResolutions(this Screen screen)
        {
            List<Size> sizes = new List<Size>();
            DEVMODE vDevMode = new DEVMODE();
            int i = 0;
            while (EnumDisplaySettings(screen.DeviceName, i, ref vDevMode))
            {
                if (IsReasonableDisplayResolution(vDevMode) && SupportsNormalColour(vDevMode))
                {
                    Size newsize = new Size(vDevMode.dmPelsWidth, vDevMode.dmPelsHeight);
        ...
        {
            return !(1 << vDevMode.dmBitsPerPel > MinimumColour);
        }

        public static List<Monitor> GetMonitorInformation()
        {
            List<Monitor> monitors = new List<Monitor>();
            int index = 1;
            foreach (Screen screen in Screen.AllScreens)
            {
                Monitor monitor = new Monitor(screen.DeviceName);
                monitor.Id = index;
        ...
        public static WindowOption GetWindowOption(List<WindowOption> optionsList, bool isFullscreen, bool isBorderless)
        {
            try
            {
                return optionsList.Where(x => x.IsFullscreen == isFullscreen && x.IsBorderless == isBorderless).First();
            }
            catch
            {
