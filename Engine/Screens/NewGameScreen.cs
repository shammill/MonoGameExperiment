...
namespace Engine.Screens
{
    public class NewGameScreen : Screen
    {
        ...
        private Textbox newGame = new Textbox() { Location = new Vector2(), Value = "Game Type:" };
        private Textbox loadGame = new Textbox() { Location = new Vector2(), Value = "Tiles:" };
        private Textbox options = new Textbox() { Location = new Vector2(), Value = "Rotation:" };
        private Textbox exit = new Textbox() { Location = new Vector2(), Value = "Back" };
