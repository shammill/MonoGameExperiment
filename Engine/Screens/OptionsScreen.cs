...
namespace Engine.Screens
{
    public class OptionsScreen : Screen
    {
        ...
        private Textbox newGame = new Textbox() { Location = new Vector2(), Value = "Audio" };
        private Textbox loadGame = new Textbox() { Location = new Vector2(), Value = "do we do video here?" };
        private Textbox options = new Textbox() { Location = new Vector2(), Value = "" };
        private Textbox exit = new Textbox() { Location = new Vector2(), Value = "Main Menu" };
